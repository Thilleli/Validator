...
?>
	<div class="Contact">
			<p><img src="images/phone.png" width="50px" height="50px" /><strong>Par téléphone:</strong></p>
			<p>Thilleli:07 67 73 30 79</p><p>Alexandra:06 52 07 68 14</p>

			</p><img src="images/courriel.png" width="50px" height="50px"/><strong>Par courriel:</strong></p>
			<p>th.belhocine@gmail.com</p><p>alex.wasef@gmail.com</p>

			<p><img src="images/git.png" width="50px" height="50px" /><strong>N'hésitez pas à aller jeter un coup d'oeuil sur nos pages github:</strong></p>
